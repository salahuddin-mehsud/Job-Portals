      ...
      <div className="text-center border-b border-gray-200 ">
        ...
        <div className="px-8 py-4 ">
            ...
            <div className="flex justify-between items-center mt-4 " >
                <h2 className="font-medium text-accent text-xl ">Rs.{price}</h2>
                <div className="flex gap-2 items-center bg-pink text-white px-4 py-2 cursor-pointer hover:bg-accent " onClick={addProductToCart}><AiOutlineShoppingCart/> Add to Cart </div>
            </div>
